...
import { ProjectTypeService } from 'src/app/_shared/services/project-type.service';

@Component({
  selector: 'app-project-type-data',
  templateUrl: './project-type-data.component.html',
  styleUrls: ['./project-type-data.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class ProjectTypeDataComponent extends BaseDataComponent implements OnInit {

  constructor(
    fb: FormBuilder,
    private ex: ExtensionService,
    private sv: ProjectTypeService,
  ...
  async ngOnInit() {
    this.createForm({
      data: this.fb.group({
        projTypeNameVn: [{ value: null, disabled: this.isView }, [GlobalValidate.required({ error: 'Không được để trống' })]],
