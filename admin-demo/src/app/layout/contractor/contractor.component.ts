...
export class ContractorComponent extends BaseListComponent implements OnInit {
      ...
      if (!isNaN(+formSearch.txtSearch)) {
        where.and.push({
          or: [
            ...
            { 'data.contractorIndex': formSearch.txtSearch }
          ]
        });
      } else {
        where.and.push({
          or: [
            { 'data.contractorName': { like: this.ex.BoDau(formSearch.txtSearch) } },
          ]
        });
      }
    }
  ...
  //     where.and.push({
  //       or: [
  //         { 'id': { like: this.ex.BoDau(formSearch.txtSearch) } },
  //         { 'data.contractorName': { like: this.ex.BoDau(formSearch.txtSearch) } },
  //         { 'data.contractorIndex': { like: this.ex.BoDau(formSearch.txtSearch) } },
  //       ]
  //     });
  //   }
  //   if (formSearch.status !== null) {
