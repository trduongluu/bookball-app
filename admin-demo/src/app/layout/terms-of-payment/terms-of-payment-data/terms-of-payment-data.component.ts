...
@Component({
  selector: 'app-terms-of-payment-data',
  templateUrl: './terms-of-payment-data.component.html',
  styleUrls: ['./terms-of-payment-data.component.scss']
})
export class TermsOfPaymentDataComponent extends BaseDataComponent implements OnInit {

  constructor(
    fb: FormBuilder,
    private ex: ExtensionService,
    private sv: TermsOfPaymentService,
  ...
  async ngOnInit() {
    this.createForm({
      data: this.fb.group({
        termsOfPaymentName: [{ value: null, disabled: this.isView }, [GlobalValidate.required({ error: 'Không được để trống' })]],
