...
@Component({
  ...
  styleUrls: ['./terms-of-payment.component.scss']
})
export class TermsOfPaymentComponent extends BaseListComponent implements OnInit {
    ...
    if (formSearch.txtSearch) {
      where.and.push({
        or: [
          ...
          { 'data.termsOfPaymentName': { like: this.ex.BoDau(formSearch.txtSearch) } },
        ]
      });
    }
