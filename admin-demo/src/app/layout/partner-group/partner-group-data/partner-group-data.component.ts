...
@Component({
  selector: 'app-partner-group-data',
  templateUrl: './partner-group-data.component.html',
  styleUrls: ['./partner-group-data.component.scss']
})
export class PartnerGroupDataComponent extends BaseDataComponent implements OnInit {

  constructor(
    fb: FormBuilder,
    private ex: ExtensionService,
    private sv: PartnerGroupService,
  ...
  async ngOnInit() {
    this.createForm({
      data: this.fb.group({
        partnerGroupNameVn: [{ value: null, disabled: this.isView }, [GlobalValidate.required({ error: 'Không được để trống' })]],
