...
export class TargetDataComponent extends BaseDataComponent implements OnInit {
  ...
  async ngOnInit() {
    this.createForm({
      data: this.fb.group({
        ...
        targetNameVn: [{ value: null, disabled: this.isView }, [GlobalValidate.required({ error: 'Không được để trống' })]],
